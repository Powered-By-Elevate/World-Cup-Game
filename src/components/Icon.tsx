...
export type IconName =
  ...
  | 'globe' | 'copy' | 'refresh' | 'edit' | 'chat' | 'bell';
...
export function Icon({ name, size = 21, stroke = 2 }: IconProps) {
  ...
  switch (name) {
    ...
    case 'gear':   return <svg {...p}><circle cx="12" cy="12" r="3.3" /><path d="M19.4 12.9c.04-.3.06-.6.06-.9s-.02-.6-.06-.9l1.9-1.5-1.9-3.3-2.3 1a7 7 0 0 0-1.6-.9L15.1 4H8.9l-.4 2.4a7 7 0 0 0-1.6.9l-2.3-1-1.9 3.3 1.9 1.5c-.04.3-.06.6-.06.9s.02.6.06.9l-1.9 1.5 1.9 3.3 2.3-1a7 7 0 0 0 1.6.9l.4 2.4h6.2l.4-2.4a7 7 0 0 0 1.6-.9l2.3 1 1.9-3.3-1.9-1.5Z" /></svg>;
    ...
    case 'chat':   return <svg {...p}><path d="M21 11.5a7.5 8 0 0 1-10.6 7.3L4 20.5l1.8-5A7.6 8 0 1 1 21 11.5z" /><path d="M8.5 10.5h7M8.5 13.5h4.5" /></svg>;
